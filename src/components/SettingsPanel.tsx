...
import type { AppSettings, InstalledEditorApp, ThemeMode, UpdateSettingsOptions } from '../types/app';
		...
		<section className="settingsPage" aria-label={copy.settings.title}>
			...
			<div className="settingRow">
				...
				<EditorMultiSelect
					...
					onChange={(selected) =>
						onUpdateSettings({ restartEditorTargets: [selected] }, { silent: true, keepInteractive: true })
					}
				/>
			</div>
